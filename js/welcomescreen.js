  ...
  Welcomescreen = function (slides, options) {
    ...
    var self = this,
      ...
      defaults = {
        ...
        closeButtonText : 'Menu', // close button text
        ...
        parallaxBackgroundImage: 'img/background.jpg', // parallax default background image
    ...
    function defineDefaultTemplate() {
      ...
      '<div class="welcomescreen-container {{#if options.cssClass}}{{options.cssClass}}{{/if}}">' +
		...
		'<div class="navbar"> ' +
                      ...
                      ' <div class="center" style="text-transform:uppercase;">This Week at Calvary!</div>' +
                     ' </div>' +
                    '</div>  ' +
        ...
        '<div class="list-block">' +
         '   <ul class="menu">' +
          '      <li>' +
                   ...
                   '     <div class="item-media"><i class="icon icon-calvary"></i></div>' +
                  '      <div class="item-inner menu">' +
                 '           <div class="item-title menu">Calvary Chapel <br/>Community Church</div>' +
                '        </div>' +
               '     </a>' +
              '  </li>' +
             '   <li>' +
            '        <a href="our-team.html" class="item-link item-content">' +
           '             <div class="item-media"><i class="icon icon-our-team size-18"></i></div>' +
          '              <div class="item-inner menu">' +
         '                   <div class="item-title menu">Our Team</div>' +
        '                </div>' +
       '             </a>' +
      '          </li>' +
     '       </ul>' +
